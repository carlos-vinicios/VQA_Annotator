...
// import { signOut } from "@utils/templates/reports";
// import { decode } from "@utils/jwt/decode";
// import { updateUserVisions, useSetCookie } from "@hooks/contexts/authContext";
...
//     const jwtDecode = decode({ cookieKey: 'systems' })
...
//       isRefreshing = true
//       const { refresh_token, username } = jwtDecode
...
//         const { access_token, first_access, visions } = response.data
//         const visionsUpdate = updateUserVisions(visions)

//         useSetCookie({
//           username,
//           access_token,
//           first_access,
//           visions: visionsUpdate,
